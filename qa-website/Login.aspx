...
<asp:Content ID="LoginForm" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Login ID="Login1" runat="server" DestinationPageUrl="~/Default.aspx" DisplayRememberMe="False" OnAuthenticate="Login1_Authenticate" VisibleWhenLoggedIn="False" OnLoggedIn="Login1_LoggedIn">
    </asp:Login>
</asp:Content>
