            ...
            <div class="card border-primary mb-3">
                <div class="card-header">
                    <div class="row">
                        ...
                        <asp:PlaceHolder runat="server" ID="QuestionSortButtons" Visible="True">
                ...
                <div class="card-body">
                    <asp:ListView runat="server" ID="QuestionsList"
                        ...
                        <EmptyDataTemplate>
                            <h5 class="text-warning text-center">There is no any question.</h5>
                        </EmptyDataTemplate>
                    </asp:ListView>
            ...
            <div class="card border-primary mb-3">
                <div class="card-header">
                    <div class="row">
                        ...
                        <asp:PlaceHolder runat="server" ID="AnswerSortButtons" Visible="True">
                            <div class="col-6 text-right">
                                <div class="btn-group btn-group-toggle">
                ...
                <div class="card-body">
                    <asp:ListView runat="server" ID="AnswersList"
                        ...
                        <EmptyDataTemplate>
                            <h5 class="text-warning text-center">There is no any answer.</h5>
                        </EmptyDataTemplate>
                    </asp:ListView>
                    <div class="mt-2 text-center">
